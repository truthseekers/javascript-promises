console.log(
  "We have removed the async and await keywords. Now we can see how the order is different because we're not pausing execution of any functions."
);
console.log(
